...
__version__ = "6.3.0"
__author__ = "Sasori#2776 || https://github.com/slumpted"
...
╩ ╚═ ╚╝ ╩╩  ╚═╝╩╚═╩ ╩ ╩ ╩╝╚╝╝╚╝╩╩ ╩
                                    ...
                                    {Fore.RED}Made by > {Fore.RESET}{__author__}

{Fore.RED}________________________________________________________________________________________________________

Logged in as {Fore.RESET}{self.user}
{Fore.RED}User id: {Fore.RESET}{self.user.id}
{Fore.RED}Servers: {Fore.RESET}{guilds}
{Fore.RED}Users:  {Fore.RESET}{users}{Fore.RED}

{Fore.RED}
Config
- - - - - - - - - - - - - - - - -
NitroSniper: {Fore.RESET}{sniper}{Fore.RED}
GiveawaySniper: {Fore.RESET}{giveaway}{Fore.RED}
SlotSniper: {Fore.RESET}{slot}{Fore.RED}

=================================


Finished start up in {Fore.RESET}{elapsed}{Fore.RED} second(s)
